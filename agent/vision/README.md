# 🚀 3-Year Vision: Build Something That Matters

**Started:** 2026-07-19
**Daily Commitment:** 1 hour (miss one day → 2 hours next day)
**Inspiration:** Bonsai white paper, Prisma's journey
**North Star:** Build an AI product that either gets acquired, gets funded, or creates worldwide impact

---

## 📋 Weekly Tracker

| Week | Dates | Hours Logged | Progress | 
|------|-------|-------------|----------|
| 1 | Jul 19-25 | | |
| 2 | Jul 26-Aug 1 | | |
| 3 | Aug 2-8 | | |
...
1. **Build in public** — GitHub, Twitter/X, LinkedIn
2. **Ship fast** — prototype in days, not months
3. **Talk to users** — before writing code
4. **No management bullshit** — product-led growth
5. **1 hour daily minimum** — compound effect over 3 years = 1095 hours
